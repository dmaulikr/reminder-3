...
-(UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath {
    ...
    Play *play = (Play *)[(self.sectionInfoArray)[indexPath.section] play];
...
-(void)handlePinch:(UIPinchGestureRecognizer*)pinchRecognizer {
    ...
    if (pinchRecognizer.state == UIGestureRecognizerStateBegan) {
		...
		SectionInfo *sectionInfo = (self.sectionInfoArray)[newPinchedIndexPath.section];
...
-(void)emailMenuButtonPressed:(UIMenuController*)menuController {
    ...
    EmailMenuItem *menuItem = [[UIMenuController sharedMenuController] menuItems][0];
...
-(void)sendEmailForEntryAtIndexPath:(NSIndexPath*)indexPath {
	...
	SectionInfo *sectionInfo = (self.sectionInfoArray)[self.pinchedIndexPath.section];
